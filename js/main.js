...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 공지 모달 (2025-10-13 Audionyx Original 프로젝트 종료) 지속 표기 로직: '다시 보지 않기' 전까지 표시
    try {
        const NOTICE_KEY = 'notice_20251013_dismissed_v1';
        const modal = document.getElementById('notice-modal-20251013');
        const btnClose = document.getElementById('notice-modal-close-20251013');
        const btnDismiss = document.getElementById('notice-modal-dismiss-20251013');
        const cta = document.getElementById('notice-modal-cta-20251013');
